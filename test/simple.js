...
tape('draw simple points', function (t) {
    t.plan(1);

    // load the renderer 
    var renderer = require(__dirname + '/data/styles/walmart-simple.js');
    var options = {};

    // the file to be saved
    var out = fs.createWriteStream( __dirname + '/results/walmart-simple.png');
